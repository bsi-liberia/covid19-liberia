  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'A visualisation of the COVID-19 response in Liberia.' },
      { name: 'twitter:card', content: 'summary' },
      { name: 'twitter:site', content: '@mfdp_lib' },
      { name: 'twitter:title', content: 'COVID-19 Response Liberia' },
      { name: 'twitter:description', content: "A visualisation of the COVID-19 response in Liberia." },
      { name: 'twitter:image', content: 'http://covidresponseliberia.org/visualisation.png' },
